...
​OAuth는 인터넷 사용자들이 비밀번호를 제공하지 않고도 다른 웹사이트나 애플리케이션이 자신의 정보에 접근할 수 있도록 권한을 위임하는 개방형 표준 프로토콜입니다. 이를 통해 사용자는 자신의 자격 증명을 노출하지 않으면서도 타사 애플리케이션이 특정 리소스에 접근하도록 허용할 수 있습니다.
